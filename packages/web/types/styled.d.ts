...
export declare function styled<ParentComponent extends StylableComponent, Variants extends VariantDefinitions<ParentComponent>, StyledStaticConfig extends StaticConfigPublic = {}>(ComponentIn: ParentComponent, options?: Partial<GetProps<ParentComponent>> & {
    name?: string;
